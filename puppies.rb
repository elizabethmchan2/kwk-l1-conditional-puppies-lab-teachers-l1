# 1. Write a method called no_puppies that takes in a number of puppies as an argument. If the number of puppies is greater than zero then this method should return "Get back to your animal goals!" otherwise it should return "Good job, Rachel!""
...
def both_animals(numP, numC)
  if numP == 0 or numC == 0 
    "Good job!"
    elsif numP >= 1 and numC >= 1 
    "Get back to your animal goals!"
  else
  end
end
